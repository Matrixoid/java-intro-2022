...
public class WsppCountPosition {
    public static void main(String[] args) {
        ...
        try {
            ...
            List<Map.Entry<String, IntListEasy>> entries = new ArrayList<>(result.entrySet());
            Comparator<Map.Entry<String, IntListEasy>> sizeComparator = Comparator.comparingInt(entry -> entry.getValue().size());
            Collections.sort(entries, sizeComparator);
            for (Map.Entry<String, IntListEasy> p : entries) {
